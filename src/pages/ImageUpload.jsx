  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result2 = await axios.post(
        "https://roomiez-backend-deployment.onrender.com/api/v1/imagetodb",
        {
          url: url,
          t2: t2, //from state
        }
              ...
              >
                <div className="relative flex flex-col gap-y-6">
                  ...
                  <div className="relative flex flex-row">
                    ...
                    <button
                      className="relative bg-white text-gray-500 font-semibold text-base  w-[200px]  h-[100px] flex flex-col items-center justify-center cursor-pointer border-2 rounded-[25px]  border-dashed mx-auto font-[sans-serif] border-red-400   "
                      onClick={() => {
                        navigate(`/addlocations/${id}`);
                      }}
                    >
                      prev
                    </button>
                    <button className="relative bg-white text-gray-500 font-semibold text-base  w-[200px]   h-[100px] flex flex-col items-center justify-center cursor-pointer border-2 rounded-[25px]  border-dashed mx-auto font-[sans-serif] border-red-400   ">
                      {" "}
                      Submit
                    </button>
                  </div>

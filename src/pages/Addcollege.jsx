      ...
      <div className= '  relative   border  flex  flex-row   md:gap-x-3 md:space-x-5  h-screen          '>
        <div className='relative bg-gray-400  w-screen h-screen flex items-center  '>
          ...
          <div className='relative  flex flex-col   h-1/2 justify-center items-center md:border   gap-3      '>
            <div className='relative flex justify-center items-center w-screen ' ><input className='border h-10 w-2/3 md:w-[500px] text-center font-light text-xl hover:border-gray-700'  placeholder='COLLEGE NAME' onChange={(e)=>{setcollegeName(e.target.value)}} ></input></div>
            <div className='relative flex justify-center items-center w-screen '  ><input  className='border  h-10 w-2/3 md:w-[500px]  text-center font-light text-xl hover:border-gray-700' placeholder='COLLEGE CODE' onChange={(e)=>{setCode(e.target.value)}}  ></input></div>
            <div className='relative flex justify-center items-center  w-screen' ><input   className='border  h-10 w-2/3 md:w-[500px] text-center font-light text-xl hover:border-gray-700' placeholder='COLLEGE EMAIL ' onChange={(e)=>{setcollegeEmail(e.target.value)}}></input></div>
            <div className='relative flex justify-center items-center  w-screen' ><input   className='border h-10 w-2/3 md:w-[500px] text-center font-light text-xl hover:border-gray-700 ' placeholder='COLLEGE ADDRESS' onChange={(e)=>{setaddress(e.target.value)}}></input></div>
            <div className='relative flex justify-center items-center  w-screen' ><button onClick={handleSubmit} class="relative w-2/3 md:w-[500px]  bg-transparent hover:bg-slate-400 text-neutral-50 font-semibold hover:text-white py-2 px-4 border border-red-50 hover:border-transparent rounded">
              Add College
            </button>
            {/* <ToastContainer autoClose={10000} /> */}
            </div>

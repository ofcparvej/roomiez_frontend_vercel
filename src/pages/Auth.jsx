...
const Auth = () => {
  ...
  return (
    <div className='w-screen h-screen  '  > 
        <div className='     flex items-center shadow-lg h-[70px]   md:h-[105px] bg-slate-200   sticky   border  flex-row  justify-between' >   
        ...
        <div class="flex flex-row  justify-center items-center  ">
          <div className='relative flex flex-col justify-center items-center gap-16 '>
                 <div className='  lg:text-6xl mt-28 text-xl md:text-4xl text-center md:text-center font-Montserrat  hover:underline decoration-2 '>  Welcome To   <span className=''>  Roomiez </span>  </div>
                 
                 <div className=' relative     lg:text-xl bg-opacity-10  hover:shadow-md  text-center font-edusahand md:text-xl text-sm     '>
                    <p className='m-3 text-center'>
      Your reliable companion in finding the perfect room near your college.
We are a student-focused accommodation platform dedicated to helping college-students discover nearby, affordable, and verified room options with ease.
Whether you're new to town or simply shifting places, Roomies connects you with listings that suit your budget and lifestyle.
Say goodbye to stressful house-hunting and let us simplify your search for a comfortable stay.

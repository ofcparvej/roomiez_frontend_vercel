    ...
    <div className='   '>
      <div  onClick={()=>{navigate(`/locations/${props.data.collegeCode}`)}} >
        <div class="max-w-sm  rounded overflow-hidden shadow-lg h-[500px] " >
          <CardHeader color="blue-gray" className="relative w-full object-cover h-[300px] flex justify-center items-center ">
            <img
          ...
          <div class="px-6 py-4">
            <div class="font-bold  mb-2 flex justify-center items-center ">Loading ...</div>
